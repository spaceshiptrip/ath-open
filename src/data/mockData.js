...
// HSB: women rotate freely (no fixed couples). Blue Crew: couples always play together.
// Blue Crew couples: b1(Alexis)↔b6(Trevor), b9(Carmela)↔b3(Marv), b10(Ivy)↔b12(Pierre)
// Marv(b3)/Carmela(b9) drew 3 mixed; Arman(b4)/Richard(b7) play 4 men's — both unavoidable
...
export const mockMatches = [
  ...
  { id: 'm1',  round: 1, court: 'S', isMix: false, teamAP1: 'a4',  teamAP2: 'a5',  teamBP1: 'b4',  teamBP2: 'b8',  winner: '' },
  { id: 'm2',  round: 1, court: 'N', isMix: false, teamAP1: 'a6',  teamAP2: 'a7',  teamBP1: 'b5',  teamBP2: 'b7',  winner: '' },
  // Round 2 — Men's Doubles
  { id: 'm3',  round: 2, court: 'S', isMix: false, teamAP1: 'a8',  teamAP2: 'a9',  teamBP1: 'b4',  teamBP2: 'b11', winner: '' },
  { id: 'm4',  round: 2, court: 'N', isMix: false, teamAP1: 'a10', teamAP2: 'a11', teamBP1: 'b2',  teamBP2: 'b8',  winner: '' },
  // Round 3 — Men's Doubles
  { id: 'm5',  round: 3, court: 'S', isMix: false, teamAP1: 'a7',  teamAP2: 'a10', teamBP1: 'b2',  teamBP2: 'b7',  winner: '' },
  { id: 'm6',  round: 3, court: 'N', isMix: false, teamAP1: 'a6',  teamAP2: 'a12', teamBP1: 'b4',  teamBP2: 'b12', winner: '' },
  // Round 4 — Mixed Doubles ★ (both courts)
  { id: 'm7',  round: 4, court: 'S', isMix: true,  teamAP1: 'a4',  teamAP2: 'a1',  teamBP1: 'b3',  teamBP2: 'b9',  winner: '' },
  { id: 'm8',  round: 4, court: 'N', isMix: true,  teamAP1: 'a5',  teamAP2: 'a2',  teamBP1: 'b6',  teamBP2: 'b1',  winner: '' },
  // Round 5 — Mixed South ★, Men's North
  { id: 'm9',  round: 5, court: 'S', isMix: true,  teamAP1: 'a5',  teamAP2: 'a3',  teamBP1: 'b3',  teamBP2: 'b9',  winner: '' },
  { id: 'm10', round: 5, court: 'N', isMix: false, teamAP1: 'a12', teamAP2: 'a9',  teamBP1: 'b4',  teamBP2: 'b7',  winner: '' },
  // Round 6 — Men's Doubles
  { id: 'm11', round: 6, court: 'S', isMix: false, teamAP1: 'a11', teamAP2: 'a7',  teamBP1: 'b2',  teamBP2: 'b11', winner: '' },
  { id: 'm12', round: 6, court: 'N', isMix: false, teamAP1: 'a4',  teamAP2: 'a8',  teamBP1: 'b6',  teamBP2: 'b5',  winner: '' },
  ...
  { id: 'm15', round: 8, court: 'S', isMix: false, teamAP1: 'a10', teamAP2: 'a6',  teamBP1: 'b7',  teamBP2: 'b8',  winner: '' },
  { id: 'm16', round: 8, court: 'N', isMix: false, teamAP1: 'a11', teamAP2: 'a5',  teamBP1: 'b5',  teamBP2: 'b11', winner: '' },
  // Round 9 — Mixed Doubles ★ (both courts)
  { id: 'm17', round: 9, court: 'S', isMix: true,  teamAP1: 'a9',  teamAP2: 'a2',  teamBP1: 'b12', teamBP2: 'b10', winner: '' },
